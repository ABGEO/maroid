...
A guideline does not divide. `TRC-002` binds one prefix to one file. A guideline
that passes its target cuts text, moves a rule to the guideline that owns its
subject, or retires a rule.
